...
final class Version20180531173942 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE mooc_elements (id INT UNSIGNED AUTO_INCREMENT NOT NULL, chapter_id INT UNSIGNED DEFAULT NULL, name VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, display_order SMALLINT DEFAULT 1 NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, type VARCHAR(255) NOT NULL, youtube_url VARCHAR(255) DEFAULT NULL, youtube_thumbnail_url VARCHAR(255) DEFAULT NULL, content VARCHAR(800) DEFAULT NULL, INDEX IDX_691284C5579F4768 (chapter_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
